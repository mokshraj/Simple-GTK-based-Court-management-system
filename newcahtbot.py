...
PROJECT_CONTEXT = context.context()
import requests

GEMINI_API_KEY = "AIzaSyBykc__glwO4JWJV5Nab2kO6bsEMM3WF_Q"
GEMINI_API_URL = "https://generativelanguage.googleapis.com/v1/models/gemini-2.5-flash:generateContent"
FILES_API_URL = "https://generativelanguage.googleapis.com/v1/files"

def ask_gemini_with_file(message, file_uri):
    """Send a message with a file reference to Gemini"""
            ...
            try:              
                if hasattr(self, "_last_typing_widget"):
                    ...
                    try:
                        ...
                        pass
                self._safe_add_bubble("bot", reply, "#d6d9f6")
                self._log("Bot", reply)
            except Exception:
                pass
